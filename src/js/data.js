...
export var guideContent = {
  ...
  Urdu: {
    topText: (
      <>
        <div>
          Jab aap event gifts bhejen gy, toh aap haasil karen gy <span className="c-green">Jashan Points.</span>
        </div>
        <div>
          1 bean of event gift sent = <span className="c-green">1 Jashan Point.</span>
        </div>
    ...
    firstBox: (
      <ul>
        ...
        <li>
          Aap "+" plus key par tap karke us mine k saath khelne ka chance barha sakty hain ya text input box mein desired number value daal sakty
          hain.
        </li>
        <li>Game khelne k liye, aap 5x5 gird battle field par kahin bhi tap kar sakty hain ya "Start" button par tap kar sakty hain.</li>
        <li>
          Jab aap select ki hui mine k sath battlefield par kahin bhi tap karty hain ya "Start" button par tap karty hain, toh Jashan Points mine ki
          qisam k mutabiq kaat jayengy aur aap ko inaam milega.
        </li>
        <li className="c-yellow">Game khelne k 2 outcomes hain, i.e. Success and Failure.</li>
        <li>Har dafa jab aap battle win karty hain, i.e. outcome success hai, toh "Daily Enemies Defeated" counter mein value "1" add hojaye gi.</li>
        <li>“Daily Enemies Defeated” counter har roz 00:00:00 GMT par reset hoga.</li>
        <li>Har dafa jab aap battle win karty hain, i.e. outcome success hai, toh “War Victory” Progress Bar usk mutabiq barh jayegi.</li>
        <li>
          Jab aap 20 martaba enemies ko kamiyabi sy defeat karty hain, toh ap war jeet jayen gy aur aap ko 2000 beans clearance reward milein gy, aur
          phir progress bar ka naya round shuru hojaye ga, yani isay baar baar mukammal kiya ja sakta hai.
        </li>
        <li>“War Victory” Progress Bar har roz zero par reset nahi hogi.</li>
        <li>Sabse zyada “Daily Enemies Defeated” wale users ko leaderboard par dikhaya jayega aur unhy Beans Pot Rewards milein gy.</li>
        <li className="c-yellow">
    ...
    secondBox: (
      <ul>
        ...
        <li>
          Jab aap text input box mein koi value dale bina “Build” button par tap karty hain, toh default value '1' hogi, 20K Jashan points kaat
          jayengy aur aapko “10” construction points aur rewards milein gy.
        </li>
        <li>
          ...
          agar aap '5' ki value daalty hain, toh 5*20,000 = 100,000 Jashan points kaat jayengy aur aapko “50” construction points aur 5 rewards milein
          gy.
        </li>
        <li>Jab aap building construction level 3 tak pohanchte hain, toh reward k tor par beans produce hongy.</li>
        <li className="c-yellow">Ye beans level 3 sy level 6 tak produce hongy.</li>
        <li>
          Har level main beans k growth rate ka output per minute mukhtalif hai, aur har level k liye beans ki aik corresponding upper limit hai.
        </li>
        <li>Corresponding beans limit tak pohanchne k baad, mazeed beans generate nahi hongy.</li>
        <li>Jab aap level 6 tak pohanchte hain, toh aap khelna jari rakh sakty hain aur beans increase hote jayengy.</li>
        <li>
          Har dafa jab aap “Build” button par kamiyabi sy tap karke Construction Points hasil karty hain, toh “Construction Points” counter mein value
          “10” add hojaye gi.
        </li>
        <li>Har dafa jab aap next Building level tak pohanchte hain, toh “Construction Points” counter next level k liye increase hojaye ga.</li>
        <li>
          Jab aap Building Level 3 sy beans produce karna shuru karty hain, toh “Today's Estimated Rewards” counter ki value usk mutabik barhti
          jayegi.
        </li>
        <li>"Today's Estimated Rewards” counter har roz 00:00:00 GMT par reset hoga.</li>
    ...
    thirdBox: (
      <ul>
        ...
        <li className="c-yellow">1 Gem of event gift received = 1 Talent Point.</li>
        <li>Event k is hissay mein, aap fireworks kar sakte hain aur inaam jeet sakte hain.</li>
